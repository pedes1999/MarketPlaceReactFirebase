...
import { updateDoc, doc, query, collection, where, orderBy, deleteDoc, getDocs, getDoc } from 'firebase/firestore'
...
function Profile() {
    ...
    //destruct formData to get name and email
    ...
    //signs out and navigates to explore
    const onLogout = () => {
        auth.signOut()
        navigate('/')
    }
